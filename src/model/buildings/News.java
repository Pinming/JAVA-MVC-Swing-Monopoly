...
public class News extends Building {
	...
	private Image[] imgageEvents = { EVENT_BAD_HOSPITAL_3_01,
			...
			EVENT_BAD_LOSE_10000_01, EVENT_BAD_LOSE_1500_01,
			EVENT_BAD_LOSE_2000_01, EVENT_BAD_LOSE_300_01,
			EVENT_BAD_LOSE_300_02, EVENT_BAD_LOSE_3000,
			EVENT_BAD_LOSE_400_01,EVENT_BAD_LOSE_500_01,
	 ...
	 * 事件图片
	 */
	public static Image EVENT_BAD_LOSE_10000_01 = new ImageIcon(
			"images/event/bad_lose10000.jpg").getImage();
	/**
	 * 事件图片
	 */
