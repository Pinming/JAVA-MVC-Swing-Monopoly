...
public class LandModel extends Tick implements Port {
	...
	public void setLandsIMG(Image landsIMG) {
	 ...
	 protected int[][] land = {
			 // 模仿大富翁其中一个地图设置
				{ ORIGIN, SPACE, SPACE, SPACE, LOTTERY, SPACE, SPACE, SPACE, SPACE, MONEY_1000, SPACE, SPACE,SPACE, LOTTERY },
				...
				{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET,NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET,NULL_SET,NULL_SET,SPACE },
				{ SPACE, NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET,NULL_SET, NULL_SET, NULL_SET, NULL_SET, NULL_SET,NULL_SET,NULL_SET,SPACE },
				{ PRISON, SPACE, SPACE, SPACE, MONEY_2000, SPACE, SPACE, SPACE,CHANCE, SPACE, SPACE,SPACE, SPACE,HOSPITAL },
	 };
