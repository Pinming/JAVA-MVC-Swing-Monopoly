...
public class LandModel extends Tick implements Port {
    ...
    protected int[][] land = {
            // 模仿大富翁其中一个地图设置
            {ORIGIN, CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE,CHANCE},
//            {ORIGIN, SPACE, SPACE, SPACE, NEWS, SPACE, SPACE, SPACE, SPACE, MONEY_1000, SPACE, SPACE, SPACE, LOTTERY},
